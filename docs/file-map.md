...
| `docs/workflow-object-schema.md` | Reverse-engineered `info.plist` object schema (Alfred doesn't document this); `docs/alfred-workflow-object-types.plist` is the underlying reference export | — |
